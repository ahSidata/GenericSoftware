...
namespace EnergyAutomate.Migrations
{
    ...
    [Migration("20260501113641_AddCodeTemplateVersioning")]
    partial class AddCodeTemplateVersioning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnergyAutomate.Data.Entities.CodeTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnergyAutomate.Data.Entities.CodeTemplateHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CodeTemplateId", "Version")
                        .IsUnique();

                    b.ToTable("CodeTemplateHistories");
                });
            ...
            modelBuilder.Entity("EnergyAutomate.Growatt.DeviceList", b =>
                {
                    ...
                    b.Property<int>("PowerValueBatteryPower")
                        .HasColumnType("int");

                    b.Property<int>("PowerValueBatteryStatus")
                        .HasColumnType("int");

                    b.Property<int>("PowerValueCommited")
                        .HasColumnType("int");

                    b.Property<int>("PowerValueDefault")
                        .HasColumnType("int");

                    b.Property<DateTimeOffset?>("PowerValueLastChanged")
                        .HasColumnType("datetimeoffset");

                    b.Property<int>("PowerValueOutput")
                        .HasColumnType("int");

                    b.Property<int>("PowerValueRequested")
                        .HasColumnType("int");

                    b.Property<int>("PowerValueSolar")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnergyAutomate.Tibber.TibberRealTimeMeasurement", b =>
                {
                    ...
                    b.Property<int?>("PowerValueBattery")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnergyAutomate.Data.Entities.CodeTemplateHistory", b =>
                {
                    b.HasOne("EnergyAutomate.Data.Entities.CodeTemplate", "CodeTemplate")
                        .WithMany("History")
